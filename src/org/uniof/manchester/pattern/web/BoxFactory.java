	...
	public BoxEntity createBox(String boxType, double height, double width, double depth, double thickness, String colour, String door_colour, ArrayList<ExtraParts> extrasKW, String mat, String FurType){
		...
		if(FurType.equalsIgnoreCase("K")) {
			...
			if (boxType.equalsIgnoreCase("Box with shelf")) {
				...
				box.setPieces(box.calculatePieces(height, width, depth, thickness, colour, door_colour, mat, 1, 0));
				box.setExtras(box.calculateExtraParts(extrasKW, 0, 1));
				return box;
				...
				box.setPieces(box.calculatePieces(height, width, depth, thickness, colour, door_colour, mat, 0, 3));
				box.setExtras(box.calculateExtraParts(extrasKW, 3, 0));
				return box;
				...
				box.setPieces(box.calculatePieces(height, width, depth, thickness, colour, door_colour, mat, 0, 4));
				box.setExtras(box.calculateExtraParts(extrasKW, 4, 0));
				return box;
			}
			...
			if (boxType.equalsIgnoreCase("Box with bar and 2 shelves")) {
				...
				box.setPieces(box.calculatePieces(height, width, depth, thickness, colour, door_colour, mat, 2, 0));
				box.setExtras(box.calculateExtraParts(extrasKW, 0, 2));
				return box;
